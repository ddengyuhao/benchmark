...
\begin{table*}[t]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|}
		...
		\hline
		\rowcolor{gray!40}
		OpenData Small& Join \& Union  & XX & XX  & XX  & 101 & \Checkmark  \\
		\hline
		\rowcolor{gray!40}
		OpenData Large& Join \& Union  & XX & XX  & XX  & 1111.4 & \Checkmark  \\
		\hline
		\rowcolor{gray!40}
		WebTable Small& Join \& Union  & XX & XX  & XX  & 13 & \Checkmark\\
		\hline
		\rowcolor{gray!40}
		WebTable Large& Join \& Union  & XX & XX  & XX  & 77 &\Checkmark \\
		\hline
	\end{tabular}
