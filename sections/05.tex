...
Figure~\ref{fig:interface} shows the interface for the join search, which mainly consists of three parts. The interface  of the union search follows a similar structure.
